...
public class ProdutoVIEW extends javax.swing.JInternalFrame {
    ...
    ResultSet rs;
    DefaultTableModel model_jtl_consultar_produto;
    DefaultTableModel model_jtl_consultar_fornecedor;
    ...
    public ProdutoVIEW() {
        ...
        model_jtl_consultar_fornecedor = (DefaultTableModel) jtl_consultar_fornecedor.getModel();
        model_jtl_consultar_produto = (DefaultTableModel) jtl_consultar_produto.getModel();
    }
    ...
    private void initComponents() {
        ...
        brnPesquisarProduto = new javax.swing.JButton();
        ...
        pesquisa_nome_prod.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                pesquisa_nome_prodActionPerformed(evt);
            }
        });

        brnPesquisarProduto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/projeto_3/view/imagens/pesquisar.png"))); // NOI18N
        brnPesquisarProduto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                brnPesquisarProdutoActionPerformed(evt);
            }
        });
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(cod_bar_prod, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(jLabel5)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(p_venda_prod, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(pesquisa_nome_fornecedor, javax.swing.GroupLayout.PREFERRED_SIZE, 365, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(pesquisa_nome_prod, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(brnPesquisarProduto))))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(138, 138, 138)
    ...
    private void pesquisa_nome_prodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pesquisa_nome_prodActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_pesquisa_nome_prodActionPerformed
    ...
    private void btnPesquisarFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarFornecedorActionPerformed
        preencheTabelaFornecedor(pesquisa_nome_fornecedor.getText());        // TODO add your handling code here:
    ...
    private void brnPesquisarProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_brnPesquisarProdutoActionPerformed
        preencheTabelaProduto(pesquisa_nome_prod.getText());
        // TODO add your handling code here:
    }//GEN-LAST:event_brnPesquisarProdutoActionPerformed
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        liberaCampos(false);
        liberaBotoes(true, false, false, false, true);
        model_jtl_consultar_produto.setNumRows(0);        // TODO add your handling code here:
    }//GEN-LAST:event_btnExcluirActionPerformed

    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        limpaCampos();
        liberaCampos(false);
        model_jtl_consultar_produto.setNumRows(0);
        liberaBotoes(true, false, false, false, true);
    ...
    model_jtl_consultar_fornecedor.setNumRows(0);
}
    ...
    try{
        ...
        while(rs.next()){
            model_jtl_consultar_produto.addRow(new Object[]{
    ...
    try {
        ...
        if (rs.next()) {
            ...
            model_jtl_consultar_fornecedor.setNumRows(0);
            model_jtl_consultar_fornecedor.addRow(new Object[]{rs.getInt("id_for"), rs.getString("nome_for"),});
    ...
    try{
        ...
        while(rs.next()){
            model_jtl_consultar_fornecedor.addRow(new Object[]{
                rs.getString("id_for"),
    ...
    private javax.swing.JButton brnPesquisarProduto;
